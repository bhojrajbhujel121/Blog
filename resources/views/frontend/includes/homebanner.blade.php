<section class="home_banner_area">
		<div class="owl-carousel owl-theme" id="home-owl">
			...
			<div class="slide-item owl-lazy" data-src="{{asset('frontend/img/banner/home-banner2.jpg')}}">
				<div class="container">
					<div class="row">
						<div class="col-lg-5"></div>
						<div class="col-lg-7">
							<div class="blog_text_slider">
								<div class="blog_text">
									<img class="img-fluid" src="{{asset('frontend/img/banner/banner-img2.png')}}" alt="">
									<div class="blog-meta bottom d-flex justify-content-between align-items-center flex-wrap">
										<div class="meta">
											<span class="icon fa fa-calendar"></span> March 14, 2018
											<span class="icon fa fa-comments"></span> 05
			...
			<div class="slide-item owl-lazy" data-src="{{asset('frontend/img/banner/home-banner3.jpg')}}">
				<div class="container">
					<div class="row">
						<div class="col-lg-5"></div>
						<div class="col-lg-7">
							<div class="blog_text_slider">
								<div class="blog_text">
									<img class="img-fluid" src="{{asset('frontend/img/banner/banner-img3.png')}}" alt="">
									<div class="blog-meta bottom d-flex justify-content-between align-items-center flex-wrap">
										<div class="meta">
											<span class="icon fa fa-calendar"></span> March 14, 2018
											<span class="icon fa fa-comments"></span> 05
